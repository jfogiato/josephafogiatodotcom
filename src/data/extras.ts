export const extras = [
  {
    ...
    role: "Senior Advisor",
    description:
      "Provide strategic guidance and support to a non-profit organization focused on food security and community development.",
  },
  {
    ...
    role: "Big Brother",
    description:
      "Support, love, guide, and just be there for my little, Yahsir.",
  },
  {
    ...
    role: "Volunteer",
    description:
      "Volunteering Face to Face with residents living with dementia in care communities, during hands-on art-making and/or arts-based conversation programs.",
  },
  {
    ...
    role: "Volunteer",
    description:
      "Supporting the mission of Double Trellis by delivering diginified food to my community.",
  },
];
