    ...
    <div className="flex flex-col items-center min-h-screen bg-white text-black dark:bg-black dark:text-white p-8">
      ...
      <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div className="space-y-8">
          ...
          <section>
            <h2 className="text-xl font-bold mb-2">Volunteer & Extracurriculars</h2>

            {extras.map((item, i) => (
              <div key={i} className="flex items-start gap-3 mb-4 text-sm text-gray-700 dark:text-gray-300">
                <Image
                  src={item.image}
